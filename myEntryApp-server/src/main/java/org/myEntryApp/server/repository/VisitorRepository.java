...
public interface VisitorRepository extends CrudRepository<Visitor, Long> {
	...
	@Query("Select visitor from Visitor visitor where visitor.activeInd=1 order by visitor.createDate desc ")
	Optional<List<Visitor>> fetchAllVisitors();

	@Query("Select visitor from Visitor visitor where visitor.visitorEmpId = :visitorEmpId and visitor.activeInd=1 order by visitor.createDate desc ")
